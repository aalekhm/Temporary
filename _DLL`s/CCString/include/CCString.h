...
struct CCString {
	...
	public:
		...
		int			indexOf(char ch);
		static int	indexOf(const char* inStr, char ch);

		int			indexOf(char ch, int fromIndex);
		static int	indexOf(const char* inStr, char ch, int fromIndex);

		int			indexOf(const char* searchStr, int fromIndex);
		static int	indexOf(const char* inStr, const char* searchStr, int fromIndex);

		int			indexOf(const char* searchStr);
		static int	indexOf(const char* inStr, const char* searchStr);
