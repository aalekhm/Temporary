...
#define TEX_ID_TERRAIN			1
#define TEX_ID_DETAIL			2
#define TEX_ID_SKYBOX_BACK		3
#define TEX_ID_SKYBOX_FRONT		4
#define TEX_ID_SKYBOX_BOTTOM	5
#define TEX_ID_SKYBOX_TOP		6
#define TEX_ID_SKYBOX_LEFT		7
#define TEX_ID_SKYBOX_RIGHT		8
#define TEX_ID_BLDG_0_0			9
#define TEX_ID_BLDG_0_1			10
#define TEX_ID_BLDG_0_2			11
#define TEX_ID_BLDG_0_3			12
#define TEX_ID_COLOUR_GREEN		13


//#define MODEL_ID_CATHEDRAL		0
#define MODEL_ID_BLDG_0			0
#define MODEL_ID_BLDG_1			1
