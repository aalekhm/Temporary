...
GLvoid glPrint(const char* fmt, ...) {			// Custom GL "Print" Routine
	...
	fontHeight = gmf[0].gmfCellIncY;
	textLength = length;

	glTranslatef(-length/2, fontHeight, 0.0f);		// Center Our Text On The Screen
...
//*/
	...
	glPrint("OpenGL %f %d %d", textLength, prevMouseX, prevMouseY); // Print GL Text To The Screen
