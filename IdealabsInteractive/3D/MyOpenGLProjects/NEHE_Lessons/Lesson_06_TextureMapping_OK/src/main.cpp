...
int initGL(GLvoid) {
	...
	if (!NeHeLoadBitmap("Data/NeHe.bmp", texture[1]))			// Load The Bitmap
		return FALSE;											// Return False If Loading Failed
...
int drawGLScene() {
	...
	glTranslatef(0.0f, 0.0f, -5.0f);					// Move Into The Screen 5 Units i.e the box drawn below will be drawn at (0x, 0y, -5z)
