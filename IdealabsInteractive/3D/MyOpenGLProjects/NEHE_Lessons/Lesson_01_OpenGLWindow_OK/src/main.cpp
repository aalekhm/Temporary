//In this camera tutorial you will learn how to incorporate
//the mouse to move the camera like in a first person shooter,
//and how to implement the strafe (sideways step) you see in these
//games also.
