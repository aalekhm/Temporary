...
int drawGLScene() {
	...
	//Lesson #04
	glTranslatef(-1.5f, 0.0f, -6.0f);					// Move Left 1.5 Units And Into The Screen 6.0 from wherever you currently were on the screen.
...
for (i = 0; i < 20; i++) {    
   /* color information here */ 
	glColor3f(float(i/20.0f), float(i/20.0f), float(i/20.0f));
