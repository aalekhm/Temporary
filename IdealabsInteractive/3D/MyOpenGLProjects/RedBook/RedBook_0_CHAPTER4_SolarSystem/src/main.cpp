...
glPushMatrix();	//Remember where you are... This now becomes your origin(Any Translation/Rotation/Scaling will be wrt this point)...
	...
	glRotatef((GLfloat) year, 1.0f, 1.0f, 0.0f);	//Sun rotates around its own axis!!!
	glScalef(1.5f, 1.5f, 1.5f);
	glutWireSphere(0.5, 20, 16);					//Sun is placed here...

glPopMatrix();	//Remove the last manipulation and revert back to where you were...i.e @ (1)
glPushMatrix();	//Remember where you are... This now becomes your origin(Any Translation/Rotation/Scaling will be wrt this point)...
	
	glColor3f (1.0, 1.0, 0.0);
	glRotatef ((GLfloat) year, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glTranslatef (2.0, 0.0, 0.0);					//and Translate(shift wrt present axis)

	glRotatef ((GLfloat) day, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glutWireSphere(0.2, 10, 8);						//Planet Mercury lies here...
...
glPushMatrix();	//Remember where you are... This now becomes your origin(Any Translation/Rotation/Scaling will be wrt this point)...
	...
	glRotatef ((GLfloat) -year, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glTranslatef (3.0, 0.0, 0.0);					//and Translate(shift wrt present axis)

	glRotatef ((GLfloat) day, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glutWireSphere(0.3, 10, 8);						//Planet Venus lies here...
...
glPushMatrix();	//Remember where you are... This now becomes your origin(Any Translation/Rotation/Scaling will be wrt this point)...
	...
	glRotatef ((GLfloat) year, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glTranslatef (4.0, 0.0, 0.0);					//and Translate(shift wrt present axis)

	glRotatef ((GLfloat) day, 0.0, 1.0, 0.0);		//Rotate around the present axis...
	glutWireSphere(0.3, 10, 8);						//Planet Earth lies here...
	...
	glPopMatrix();//Remove the last manipulation and revert back to where you were...i.e @ (2)
