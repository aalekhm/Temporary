...
struct t3DObject 
{
	int  numOfVertices;			// The number of verts in the model
	int  numOfFaces;			// The number of faces in the model
	int  numTexVertices;			// The number of texture coordinates
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
	...
	CVector3	*pVertices;			// The object's vertices
	CVector3	*pNormals;			// The object's normals
	tVector2	*pTexVertices;			// The texture's UV coordinates
