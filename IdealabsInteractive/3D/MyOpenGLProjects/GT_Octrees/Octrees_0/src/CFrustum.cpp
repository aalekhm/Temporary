...
void CFrustum::calculateFrustum() {
	...
	CVector3 farTL = farCenter + (vCamUp * (farPlaneHeight/3)) - (vCamRight * (farPlaneWidth/3));
	CVector3 farTR = farCenter + (vCamUp * (farPlaneHeight/3)) + (vCamRight * (farPlaneWidth/3));
	CVector3 farBL = farCenter - (vCamUp * (farPlaneHeight/3)) - (vCamRight * (farPlaneWidth/3));
	CVector3 farBR = farCenter - (vCamUp * (farPlaneHeight/3)) + (vCamRight * (farPlaneWidth/3));

	CVector3 nearTL	= nearCenter + (vCamUp * (nearPlaneHeight/3)) - (vCamRight * (nearPlaneWidth/3));
	CVector3 nearTR	= nearCenter + (vCamUp * (nearPlaneHeight/3)) + (vCamRight * (nearPlaneWidth/3));
	CVector3 nearBL	= nearCenter - (vCamUp * (nearPlaneHeight/3)) - (vCamRight * (nearPlaneWidth/3));
	CVector3 nearBR	= nearCenter - (vCamUp * (nearPlaneHeight/3)) + (vCamRight * (nearPlaneWidth/3));
