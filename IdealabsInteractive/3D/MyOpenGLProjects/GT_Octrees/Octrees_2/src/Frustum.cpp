...
void CFrustum::calculateFrustum() {
	...
	CVector3 camPos		= camera.cameraPosition;
	CVector3 vCamDir	= normalize(camera.viewVector);
	CVector3 vCamUp		= normalize(camera.upVector);
	CVector3 vCamRight	= normalize(camera.rightVector);
