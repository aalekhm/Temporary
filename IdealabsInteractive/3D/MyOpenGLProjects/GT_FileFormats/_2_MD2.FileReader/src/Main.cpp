...
LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	switch(uMsg) {
		...
		break;
		case WM_RBUTTONUP:
			CURRENT_FRAME_ID = ++CURRENT_FRAME_ID % pGame3DModel.numOfObjects;
//char logText[255];
//sprintf(logText, "CURRENT_FRAME_ID %d %d", pGame3DModel.numOfObjects, CURRENT_FRAME_ID);
//MessageBox(NULL, logText, "asdas", MB_OK);
		break;
	}
