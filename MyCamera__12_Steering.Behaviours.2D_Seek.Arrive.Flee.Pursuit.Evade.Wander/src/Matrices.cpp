...
void Matrix4::rotate(const Vector3 &fwd, const Vector3 &side, const Vector3 &up)
{
	Matrix4 mat;

	mat[0] = side.x;	mat[4] = up.x;		mat[8] = fwd.x;		mat[12] = 1;

	mat[1] = side.y;	mat[5] = up.y;		mat[9] = fwd.y;		mat[13] = 1;

	mat[2] = side.z;	mat[6] = up.z;		mat[10] = fwd.z;	mat[14] = 1;
