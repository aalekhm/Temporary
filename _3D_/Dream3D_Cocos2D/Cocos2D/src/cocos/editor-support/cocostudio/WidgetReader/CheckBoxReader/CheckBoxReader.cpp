                                                               ...
                                                               flatbuffers::FlatBufferBuilder *builder)
    {
        ...
        while (child)
        {
            ...
            if (name == "NormalBackFileData")
            {
                ...
                if (backgroundboxResourceType == 1)
                {
                    ...
                    fbs->_textures.push_back(builder->CreateString(texture.c_str()));
                }
            }
        ...
        auto options = CreateCheckBoxOptions(*builder,
                                             ...
                                             CreateResourceData(*builder,
                                                                builder->CreateString(backgroundboxPath.c_str()),
																builder->CreateString(backgroundboxPlistFile.c_str()),
                                                                backgroundboxResourceType),
                                             CreateResourceData(*builder,
                                                                builder->CreateString(backGroundBoxSelectedPath.c_str()),
																builder->CreateString(backGroundBoxSelectedPlistFile.c_str()),
                                                                backGroundBoxSelectedResourceType),
                                             CreateResourceData(*builder,
                                                                builder->CreateString(frontCrossPath.c_str()),
																builder->CreateString(frontCrossPlistFile.c_str()),
                                                                frontCrossResourceType),
                                             CreateResourceData(*builder,
                                                                builder->CreateString(backGroundBoxDisabledPath.c_str()),
																builder->CreateString(backGroundBoxDisabledPlistFile.c_str()),
                                                                backGroundBoxDisabledResourceType),
                                             CreateResourceData(*builder,
                                                                builder->CreateString(frontCrossDisabledPath.c_str()),
																builder->CreateString(frontCrossDisabledPlistFile.c_str()),
