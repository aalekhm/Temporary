...
DEFINE_CUSTOM_VIEW_READER("MainMenu", SceneMainMenu, SceneMainMenuReader)
DEFINE_TOUCH_CALLBACK(SceneMainMenu)

void SceneMainMenu::LoadMembers()
{
	GET_CHILD_BY_NAME(this, m_pButtonNext,	cocos2d::ui::Button,	"Button_Next");
	{
		GLUE_BTN_EVENT_WITH_TOUCH_CALLBACK(SceneMainMenu, m_pButtonNext, this);
		m_pButtonNext->setScale9Enabled(true);
	}
}
...
void SceneMainMenu::Update(uint32_t iDeltaTimeMs)
{
