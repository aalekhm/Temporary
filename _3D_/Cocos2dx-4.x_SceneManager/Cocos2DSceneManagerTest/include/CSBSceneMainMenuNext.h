...
DECLARE_CUSTOM_VIEW_READER_CSB(CSBSceneMainMenuNextReader)
DECLARE_COCOS_CUSTOM_VIEW_CSB(CSBSceneMainMenuNext), public IGameMessageHandler, public IGameTimeHandler
{
	public:
		DECLARE_CUSTOM_VIEW_PREREQUISITES_CSB(CSBSceneMainMenuNext)
