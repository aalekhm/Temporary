...
private:
	...
	const std::string CSB_LAYER			=		"Common/Scene_Generic_PopUp.csb";
...
{
public:
	static std::unique_ptr<CocosGenericPopUpButtonInfo>&		CreateCocosGenericPopUpButtonInfo();
	virtual									~CocosGenericPopUpButtonInfo() { };
	CocosGenericPopUpButtonInfo();
	static void								DestroyPopUpInfo(std::unique_ptr<CocosGenericPopUpButtonInfo>& pInfo);
...
class CocosGenericPopUpInfo
{
	public:	
		...
		void												SetGenericPopupButtonInfo(std::unique_ptr<CocosGenericPopUpButtonInfo>& pInfo);
		std::unique_ptr<CocosGenericPopUpButtonInfo>&		GetGenericPopUpButtonInfo() { return mButtonsInfo; }
	...
	private:
		...
		std::unique_ptr<CocosGenericPopUpButtonInfo>		mButtonsInfo;
		fPopupCallback										m_fLamdaFunc;
};