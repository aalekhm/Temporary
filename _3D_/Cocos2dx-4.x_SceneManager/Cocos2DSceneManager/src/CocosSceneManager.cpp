...
{
	GameTimeController::Get().Process();
...
{
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosPushView");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosPopView");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosReplaceView");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosTransitionToGame");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosTransitionFromGame");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosQuitFromGame");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosStartLoading");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosEndLoading");
	REGISTER_MESSAGE_HANDLER(this, "eidChangeLanguage");
	REGISTER_MESSAGE_HANDLER(this, "eIdBackKeyPressed");
	REGISTER_MESSAGE_HANDLER(this, "eIdCocosApplyUserData");
	REGISTER_MESSAGE_HANDLER(this, "eIdHandleCustomUIParameters");
...
{
	UNREGISTER_MESSAGE_HANDLER(this, "eIdCocosPushView");
	UNREGISTER_MESSAGE_HANDLER(this, "eIdCocosPopView");
	UNREGISTER_MESSAGE_HANDLER(this, "eIdCocosReplaceView");
}
...
void CocosSceneManager::RegisterWithCocosView(std::string sViewName, ICocosReader* pCreatorReader)
{
	...
	if (pCocosView == nullptr)
	{
		...
		{
			pCocosView->SetCreatorReader(pCreatorReader);
		}
	}
}
...
{
	std::string sCocosViewsJson = cocos2d::FileUtils::getInstance()->getStringFromFile(sCocosViewFilePath);
...
void CocosSceneManager::HandleMessage(std::string sMessageID, const MessageData* pMessageData)
{
	if (sMessageID == "eIdCocosPushView")
	{
		//DECODE_MESSAGE_AND_CALL_COCOS_PUSHVIEW(pMessage);
	}
	else
	if(sMessageID == "eIdCocosPopView")
	{
				
	}
	else
	if(sMessageID == "eIdCocosReplaceView")
	{
...
void CocosSceneManager::SetBackgroundView(std::string sViewName)
{
	m_sBGViewName = sViewName;
}

std::string CocosSceneManager::GetBackgroundView()
{
	return m_sBGViewName;
}
///////////////////////////////////////////////////////// CocosSceneManager /////////////////////////////////////////////////////////