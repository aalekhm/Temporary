...
MANUALLY_ALIGNED_STRUCT(4) FlatSize {
 ...
 public:
  ...
  float width() const { return flatbuffers::EndianScalar(width_) * cocos2d::Director::getInstance()->getMeshValue(); }
  float height() const { return flatbuffers::EndianScalar(height_) * cocos2d::Director::getInstance()->getMeshValue(); }
};
...
MANUALLY_ALIGNED_STRUCT(4) CapInsets {
 ...
 public:
  ...
  float x() const { return flatbuffers::EndianScalar(x_) * cocos2d::Director::getInstance()->getMeshValue(); }
  float y() const { return flatbuffers::EndianScalar(y_) * cocos2d::Director::getInstance()->getMeshValue(); }
  float width() const { return flatbuffers::EndianScalar(width_) * cocos2d::Director::getInstance()->getMeshValue(); }
  float height() const { return flatbuffers::EndianScalar(height_) * cocos2d::Director::getInstance()->getMeshValue(); }
};
...
struct ButtonOptions : private flatbuffers::Table {
  ...
  int32_t fontSize() const { return GetField<int32_t>(18, 0) * cocos2d::Director::getInstance()->getMeshValue(); }
...
struct TextOptions : private flatbuffers::Table {
  ...
  int32_t fontSize() const { return GetField<int32_t>(10, 0) * cocos2d::Director::getInstance()->getMeshValue(); }
