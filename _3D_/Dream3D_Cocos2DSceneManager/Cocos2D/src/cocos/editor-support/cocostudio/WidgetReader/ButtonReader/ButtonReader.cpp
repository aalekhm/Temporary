    ...
    Offset<Table> ButtonReader::createOptionsWithFlatBuffers(const tinyxml2::XMLElement *objectData, flatbuffers::FlatBufferBuilder *builder)
    {
        ...
        auto options = CreateButtonOptions(*builder,
                                           ...
                                           CreateResourceData(*builder,
                                                              builder->CreateString(normalPath.c_str()),
                                                              builder->CreateString(normalPlistFile.c_str()),
                                                              normalResourceType),
                                           CreateResourceData(*builder,
                                                              builder->CreateString(pressedPath.c_str()),
                                                              builder->CreateString(pressedPlistFile.c_str()),
                                                              pressedResourceType),
                                           CreateResourceData(*builder,
                                                              builder->CreateString(disabledPath.c_str()),
                                                              builder->CreateString(disabledPlistFile.c_str()),
                                                              disabledResourceType),
                                           CreateResourceData(*builder,
                                                              builder->CreateString(fontResourcePath.c_str()),
                                                              builder->CreateString(fontResourcePlistFile.c_str()),
                                                              fontResourceResourceType),
                                           builder->CreateString(text.c_str()),
                                           builder->CreateString(fontName.c_str()),
                                           fontSize,
                                           &f_textColor,
                                           &f_capInsets,
                                           &f_scale9Size,
