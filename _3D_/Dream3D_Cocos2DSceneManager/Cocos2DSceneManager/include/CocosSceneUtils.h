...
class CocosSceneUtils
{
	public:
		...
		static bool							ReadCustomUIParameters(/*std::map<std::string, EA::Json::JsonDomObject*>& m_mapCustomUINodeParameters_NameObject, EA::Json::JsonDomObject* pJsonDomObject*/);
private:
	static cocos2d::Node* 					ThemedUI_ReadNodeAttributes(cocos2d::Node* pNode/*, EA::Json::JsonDomObject* pJsonDomObject*/);
		static void							ThemedUI_ReadCustomNodeAttributes(cocos2d::Node* pNode/*, EA::Json::JsonDomObject* pJsonDomObject*/);
		static void							ThemedUI_AddDynamicChildNodes(cocos2d::Node* pParent/*, EA::Json::JsonDomObject* pJsonDomObject*/);
