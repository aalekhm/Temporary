...
//		iReturnHash = EA::StdC::RotateLeft(iReturnHash, 13);
//		iReturnHash += c;
//		iCount++;
//	}
//
...
cocos2d::TargetedAction* CocosSceneUtils::CreateTargetedAction_MoveTo(cocos2d::Node* pNode, const cocos2d::Vec2& vDestPos, float fDuration)
{
	...
	cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pNode, action_MoveTo);

	return pCCTargetedAction;
}
...
cocos2d::TargetedAction* CocosSceneUtils::CreateAnimatedActionWithSpriteFrames(cocos2d::Node* pParent, const std::string& sFrameName, int32_t iMaxFrameCount, float fDuration, const cocos2d::Vec2& vAnchor, const cocos2d::Vec2& vPosition, float fAngle, float fOpacity/* = 255.0f*/)
{
	SpriteFrameCache* pSpriteFrameCache = SpriteFrameCache::getInstance();
	{
		...
		cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pSprite, pAnimate);
...
cocos2d::TargetedAction* CocosSceneUtils::CreateTargetedAction_FadeIn(cocos2d::Node* pNode, float fDuration)
{
	...
	cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pNode, action_FadeIn);
...
cocos2d::TargetedAction* CocosSceneUtils::CreateTargetedAction_FadeOut(cocos2d::Node* pNode, float fDuration)
{
	...
	cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pNode, action_FadeOut);
...
cocos2d::TargetedAction* CocosSceneUtils::CreateTargetedAction_FadeTo(cocos2d::Node* pNode, float fDuration, int8_t iOpacity)
{
	...
	cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pNode, action_FadeTo);
...
cocos2d::TargetedAction*	CocosSceneUtils::CreateTargetedAction_ScaleTo(cocos2d::Node* pNode, float fDuration, float fScaleX, float fScaleY)
{
	...
	cocos2d::TargetedAction* pCCTargetedAction = cocos2d::TargetedAction::create(pNode, action_ScaleTo);
...
cocos2d::Sequence* CocosSceneUtils::CreateSequence(cocos2d::FiniteTimeAction* pFiniteTimeAction, ...)
{
	...
	cocos2d::Sequence* pCCSequence = cocos2d::Sequence::create(vActions);
	return pCCSequence;
}
...
cocos2d::Node* CocosSceneUtils::ThemedUI_ReadParameterOverrides(cocos2d::Node* pNode/*, EA::Json::JsonDomObject* pJsonDomObject*/)
{
...
cocos2d::Node* CocosSceneUtils::ThemedUI_ReadNodeAttributes(cocos2d::Node* pNode/*, EA::Json::JsonDomObject* pJsonDomObject*/)
{
	/*
	CoefficientsManager& pCoefficientsManager = CoefficientsManager::Get();
	if (pCoefficientsManager.DoesVariableExist(EA_CHAR16("attributes"), pJsonDomObject))
	{
		EA::Json::JsonDomObject* pJsonDomObject_Attributes = pCoefficientsManager.GetJsonDomObject(EA_CHAR16("attributes"), pJsonDomObject);
...
void CocosSceneUtils::ThemedUI_ReadCustomNodeAttributes(cocos2d::Node* pNode/*, EA::Json::JsonDomObject* pJsonDomObject*/)
{
	//CoefficientsManager& pCoefficientsManager = CoefficientsManager::Get();
	//if (pCoefficientsManager.DoesVariableExist(EA_CHAR16("CustomNodeAttributes"), pJsonDomObject))
	//{
	//	EA::Json::JsonDomArray* pJsonDomArray_CutomNodeAttributes = pCoefficientsManager.GetJsonDomArray(EA_CHAR16("CustomNodeAttributes"), pJsonDomObject);
	//
...
void CocosSceneUtils::ThemedUI_AddDynamicChildNodes(cocos2d::Node* pParent/*, EA::Json::JsonDomObject* pJsonDomObject*/)
{
	//CoefficientsManager& pCoefficientsManager = CoefficientsManager::Get();
	//if (pCoefficientsManager.DoesVariableExist(EA_CHAR16("DynamicChildren"), pJsonDomObject))
	//{
	//	EA::Json::JsonDomArray* pJsonDomArray_DynamicChildren = pCoefficientsManager.GetJsonDomArray(EA_CHAR16("DynamicChildren"), pJsonDomObject);
	//
	...
	//			if (pJsonDomChildObj != NULL)
	//			{
	//				if (pCoefficientsManager.DoesVariableExist(EA_CHAR16("ClassType"), pJsonDomChildObj))
	//				{
...
void CocosSceneUtils::ThemedUI_UserData(cocos2d::Node* pNode, THEMED_PARAMETER eTHEMED_PARAMETER, void* pValue)
{
	...
	if (eTHEMED_PARAMETER == THEMED_USERDATA)
	{
		...
		if (pThisComExtensionData)
		{
			...
			//EA::GameFoundation::GameMessaging::GetServer().MessageSend(EA::TetrisApp::Message::eIdCocosApplyUserData, (void*)pNode);
		}
	}
}

bool CocosSceneUtils::ReadCustomUIParameters(/*std::map<std::string, EA::Json::JsonDomObject*>& m_mapCustomUINodeParameters_NameObject, EA::Json::JsonDomObject* pJsonDomObject*/)
{
	/*
	bool bHasCustomUIParameters = CoefficientsManager::Get().DoesVariableExist(EA_CHAR16("CustomNodeAttributesTag"), pJsonDomObject);
	if (bHasCustomUIParameters)
	{
		std::string16 sString16 = EA_CHAR16("");
		std::string sString = "";
		JSON_TRY_GET_STRING("CustomNodeAttributesTag", sString, pJsonDomObject)
			EA::StdC::ConvertString(sString, sString16);

		Json::JsonDomArray* pCustomNodesArray = CoefficientsManager::Get().GetJsonDomArray(EA_CHAR16("CocosViews.CustomNodes"));
...
void CocosSceneUtils::handleCustomUIParameters(CocosView* pCocosView, Node* pNode)
{
	...
	//std::map<std::string, EA::Json::JsonDomObject*> m_pMapCustomUINodeParameters_NameObject = *pCocosView->GetCustomUIParameterMap();
	//
	//auto it = m_pMapCustomUINodeParameters_NameObject.find(sNodeName);
	//if (it != m_pMapCustomUINodeParameters_NameObject.end())
	//{
	//	EA::Json::JsonDomObject* pJsonDomObject = m_pMapCustomUINodeParameters_NameObject[sNodeName];
	//
	//	assert(pJsonDomObject != NULL);
...
void CocosSceneUtils::applyUserData(Node* pNode, std::map<std::string, std::string>& mapUserDataOut)
{
	...
	for (; itr != mapUserDataOut.end(); ++itr)
	{
		...
		//	EA::StdC::ConvertString(sName, sName16);
		//	EA::StdC::ConvertString(sValue, sValue16);
