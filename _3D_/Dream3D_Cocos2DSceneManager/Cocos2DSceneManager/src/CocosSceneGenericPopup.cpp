...
DEFINE_CUSTOM_VIEW_READER(CocosSceneGenericPopup, CocosSceneGenericPopupReader)
...
{
	STOP_ACTION_AND_RELEASE(m_pProjectNode_Generic_popup_TimeLine)

	CocosGenericPopUpInfo* pPopupInfo = (CocosGenericPopUpInfo*)(GetCocosView()->GetViewData());
	if (pPopupInfo)
	{
		CocosGenericPopUpButtonInfo* buttoninfo = pPopupInfo->GetGenericPopUpButtonInfo();
		if (buttoninfo)
			CocosGenericPopUpButtonInfo::DestroyPopUpInfo(buttoninfo);
...
void CocosSceneGenericPopup::Update()
{
	...
	{				
		...
		std::string animName;
		animName.sprintf("animation_%d_button", numButtons);
...
{
	CocosGenericPopUpInfo* pInfo = EA_CA_NEW(CocosGenericPopUpInfo, Allocator::ICoreAllocator::GetDefaultAllocator(), "CocosGenericPopUpInfo::CreatePopUpInfo");
	return pInfo;
}
...
void CocosGenericPopUpInfo::SetGenericPopupButtonInfo(CocosGenericPopUpButtonInfo* info)
{
	mButtonsInfo = info;
}
...
CocosGenericPopUpButtonInfo* CocosGenericPopUpButtonInfo::CreateCocosGenericPopUpButtonInfo()
{
	CocosGenericPopUpButtonInfo* pInfo = std::make_unique<CocosGenericPopUpButtonInfo>();
	return pInfo;
}

void CocosGenericPopUpButtonInfo::DestroyPopUpInfo(CocosGenericPopUpButtonInfo* info)
{
	info.release();
}
